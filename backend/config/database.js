...
module.exports = {
  ...
  production: {
    use_env_variable: 'postgresql://aleks_db_user:rVdTib1VeLbb4yuByW8vWBRJCgGd4Mup@dpg-cu2binjv2p9s738q9r00-a/aleks_db', // Use DATABASE_URL for connection string in production
